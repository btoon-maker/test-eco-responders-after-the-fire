...
`Research a local fire-adapted plant. How does it help stabilize soil or promote regrowth?`,
        ...
        <svg viewBox="0 0 1000 700" preserveAspectRatio="none" aria-hidden="true">
          <defs>
            <marker id="arrowHead" markerWidth="10" markerHeight="10" refX="8" refY="5" orient="auto">
              <path d="M0,0 L10,5 L0,10 Z" fill="rgba(15,23,42,0.35)"></path>
            </marker>
          </defs>

          <path d="M500,110 C720,110 860,210 910,350" fill="none" stroke="rgba(15,23,42,0.28)" stroke-width="3" marker-end="url(#arrowHead)"/>
          <path d="M910,350 C860,520 720,600 500,600" fill="none" stroke="rgba(15,23,42,0.28)" stroke-width="3" marker-end="url(#arrowHead)"/>
          <path d="M500,600 C280,600 140,520 90,350" fill="none" stroke="rgba(15,23,42,0.28)" stroke-width="3" marker-end="url(#arrowHead)"/>
          <path d="M90,350 C140,210 280,110 500,110" fill="none" stroke="rgba(15,23,42,0.28)" stroke-width="3" marker-end="url(#arrowHead)"/>
        </svg>
  ...
  <div class="loop-example" style="margin-top:12px;">
    <strong class="hl-yellow">Reflect on The Loop</strong>: Explain what happens when your loop repeats.
...
if(closePauseModalBtn) closePauseModalBtn.addEventListener("click", closeModal);
